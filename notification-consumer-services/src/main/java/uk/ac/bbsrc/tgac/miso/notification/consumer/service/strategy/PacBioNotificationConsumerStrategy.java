...
import uk.ac.bbsrc.tgac.miso.notification.consumer.service.mechanism.PacBioNotificationMessageConsumerMechanism;
...
public class PacBioNotificationConsumerStrategy implements NotificationConsumerStrategy {
  ...
  public void consume(Message<Map<String, List<String>>> m) throws InterrogationException {
    PacBioNotificationMessageConsumerMechanism mechanism = new PacBioNotificationMessageConsumerMechanism();
