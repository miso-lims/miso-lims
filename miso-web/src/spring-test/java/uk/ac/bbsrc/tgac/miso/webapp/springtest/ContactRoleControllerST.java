...
public class ContactRoleControllerST extends AbstractST {

  private static final String CONTROLLER_BASE = "/contactrole";
  ...
  private void assertDbVsModelObjects(String resultJson, List<Long> ids) {
    ...
    for (int i = 0; i < ids.size(); i++) {
      ContactRole dbObject = currentSession().find(entityClass, ids.get(i));
