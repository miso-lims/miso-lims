...
public class ContactControllerST extends AbstractST {

  private static final String CONTROLLER_BASE = "/contact";
  ...
  private void assertDbVsModelObjects(String resultJson, List<Long> ids) {
    ...
    for (int i = 0; i < ids.size(); i++) {
      Contact dbObject = currentSession().find(entityClass, ids.get(i));
