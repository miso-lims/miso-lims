...
public class BulkDilutionIT extends AbstractIT {
  ...
  private static final Set<String> columns = Sets.newHashSet(DilColumns.NAME, DilColumns.ID_BARCODE, DilColumns.LIBRARY_ALIAS,
      DilColumns.CONCENTRATION, DilColumns.CREATION_DATE, DilColumns.VOLUME, DilColumns.TARGETED_SEQUENCING);
