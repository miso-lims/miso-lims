...
public class BulkDilutionIT extends AbstractIT {
  ...
  public void testEditSetup() throws Exception {
    ...
    BulkDilutionPage page = BulkDilutionPage.getForEdit(getDriver(), getBaseUrl(), Sets.newHashSet(100001L, 100002L, 100003L, 100004L));
  ...
  public void testPropagateToEditToPool() {
    ...
    BulkDilutionPage page = BulkDilutionPage.getForPropagate(getDriver(), getBaseUrl(), Sets.newHashSet(100002L));
    HandsOnTable table = page.getTable();
