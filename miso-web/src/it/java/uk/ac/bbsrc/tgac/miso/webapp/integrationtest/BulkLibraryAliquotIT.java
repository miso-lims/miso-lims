...
public class BulkLibraryAliquotIT extends AbstractIT {
  ...
  private static final Set<String> commonColumns = Sets.newHashSet(LibraryAliquotColumns.NAME,
      LibraryAliquotColumns.ALIAS, BulkSamplePage.SamColumns.PROJECT, LibraryAliquotColumns.TISSUE_ORIGIN,
      LibraryAliquotColumns.TISSUE_TYPE, LibraryAliquotColumns.DESCRIPTION, LibraryAliquotColumns.ID_BARCODE,
      LibraryAliquotColumns.BOX_SEARCH, LibraryAliquotColumns.BOX_ALIAS, LibraryAliquotColumns.BOX_POSITION,
      LibraryAliquotColumns.DISCARDED, LibraryAliquotColumns.EFFECTIVE_GROUP_ID, LibraryAliquotColumns.GROUP_ID,
      LibraryAliquotColumns.GROUP_DESCRIPTION, LibraryAliquotColumns.DESIGN_CODE, LibraryAliquotColumns.QC_STATUS,
      ...
      LibraryAliquotColumns.KIT, LibraryAliquotColumns.KIT_LOT, LibraryAliquotColumns.TARGETED_SEQUENCING);
