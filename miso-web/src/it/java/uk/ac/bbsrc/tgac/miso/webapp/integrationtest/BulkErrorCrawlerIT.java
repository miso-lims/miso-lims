...
public class BulkErrorCrawlerIT extends AbstractIT {
        ...
        static {
                ...
                slugs.add("sample/3/probes?addProbes=2");
                ...
                factoryPages = Collections.unmodifiableMap(new MapBuilder<String, BiConsumer<WebDriver, String>>()
                                .put("sample/bulk/new",
                                                (driver, baseUrl) -> BulkSamplePage.getForCreate(driver, baseUrl, 5,
                                                                null, "Aliquot"))
                                .put("sample/bulk/edit",
                                                (driver, baseUrl) -> BulkSamplePage.getForEdit(driver, baseUrl,
                                                                Lists.newArrayList(302L, 202L)))
                                .put("sample/bulk/propagate",
                                                (driver, baseUrl) -> BulkSamplePage.getForPropagate(driver, baseUrl,
                                                                Arrays.asList(302L, 202L),
                                                                Arrays.asList(1), "Aliquot"))
                                .put("library/bulk/propagate",
                                                (driver, baseUrl) -> BulkLibraryPage.getForPropagate(driver, baseUrl,
                                                                Arrays.asList(304L, 305L),
                                                                Arrays.asList(1)))
                                ...
                                .put("library/bulk/receive",
                                                (driver, baseUrl) -> BulkLibraryPage.getForReceive(driver, baseUrl, 3,
                                                                null, 15L))
                                .put("libraryaliquot/bulk/propagate",
                                                (driver, baseUrl) -> BulkLibraryAliquotPage.getForPropagate(driver,
                                                                baseUrl,
                                ...
                                .put("libraryaliquot/bulk/repropagate",
                                                (driver, baseUrl) -> BulkLibraryAliquotPage.getForRepropagate(driver,
                                                                baseUrl,
                                                                Arrays.asList(901L, 902L)))
                                .put("qc/bulk/addFrom/Sample",
                                                (driver, baseUrl) -> BulkQCPage.getForAddSample(driver, baseUrl,
                                                                Arrays.asList(2201L, 4447L), 1,
                                                                1))
                                .put("qc/bulk/editFrom/Sample",
                                                (driver, baseUrl) -> BulkQCPage.getForEditSample(driver, baseUrl,
                ...
                postPages = Collections.unmodifiableMap(new MapBuilder<String, Map<String, String>>()
                                ...
                                .put("pool/bulk/merge",
                                                Collections.unmodifiableMap(
                                                                new MapBuilder<String, String>().put("ids", "801,802")
                                                                                .put("proportions", "1,1")
                                                                                .build()))
        ...
        public void testFactoryPages() {
                ...
                long errors = factoryPages.entrySet().stream()
                                .filter(page -> TestUtils.checkForErrors(getDriver(), getBaseUrl(), page.getKey(),
                                                page.getValue()))
                                .count();
                assertEquals(0L, errors);
        }
