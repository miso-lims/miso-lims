...
public class LibraryTypeRestController extends AbstractRestController {
  ...
  public @ResponseBody ObjectNode bulkCreateAsync(@RequestBody List<LibraryTypeDto> dtos) throws IOException {
