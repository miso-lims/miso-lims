...
public class LabRestController extends AbstractRestController {
  ...
  public @ResponseBody ObjectNode bulkCreateAsync(@RequestBody List<LabDto> dtos) throws IOException {
