...
@Controller
@RequestMapping("/worksetcategory")
public class WorksetCategoryController extends AbstractTypeDataController<WorksetCategory, SimpleAliasableDto> {
  ...
  public ModelAndView list(ModelMap model) throws IOException {
    return listStatic(worksetCategoryService.list(), model);
  }
  ...
  @Override
  protected ProviderService<WorksetCategory> getService() {
    return worksetCategoryService;
  }

  @Override
  protected SimpleAliasableDto toDto(WorksetCategory object) {
