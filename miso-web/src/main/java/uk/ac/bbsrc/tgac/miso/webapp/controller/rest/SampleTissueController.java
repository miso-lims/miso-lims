...
public class SampleTissueController extends RestController {
  ...
  @ResponseBody
  public SampleTissueDto getInstitute(@PathVariable("id") Long id, UriComponentsBuilder uriBuilder) {
  ...
  @ResponseBody
  public Set<SampleTissueDto> getInstitutes(UriComponentsBuilder uriBuilder) {
  ...
  @ResponseBody
  public ResponseEntity<?> createInstitute(@RequestBody SampleTissueDto sampletissueDto, UriComponentsBuilder uriBuilder)
      throws IOException {
