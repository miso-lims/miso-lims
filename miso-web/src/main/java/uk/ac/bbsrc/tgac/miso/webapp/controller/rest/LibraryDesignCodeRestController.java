...
public class LibraryDesignCodeRestController extends AbstractRestController {
  ...
  public @ResponseBody ObjectNode bulkCreateAsync(@RequestBody List<LibraryDesignCodeDto> dtos) throws IOException {
