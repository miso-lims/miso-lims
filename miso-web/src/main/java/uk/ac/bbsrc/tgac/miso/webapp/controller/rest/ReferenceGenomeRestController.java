...
public class ReferenceGenomeRestController extends AbstractRestController {
  ...
  public @ResponseBody ObjectNode bulkCreateAsync(@RequestBody List<ReferenceGenomeDto> dtos) throws IOException {
