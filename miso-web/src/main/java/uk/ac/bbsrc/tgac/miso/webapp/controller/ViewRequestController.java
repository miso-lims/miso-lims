...
public class ViewRequestController {
   ...
   * new ModelAndView("/pages/viewRequest.jsp", "request", request); } catch (IOException ex) { if (log.isDebugEnabled()) {
   * log.debug("Failed to show request", ex); } throw ex; } }
   * 
   ...
   * .getResultsControllerUrl() + "/" + requestId + "/" + executionCount; } catch (IOException ex) { if (log.isDebugEnabled()) {
   * log.debug("Failed to show request results", ex); } throw ex; } }
   */
}
