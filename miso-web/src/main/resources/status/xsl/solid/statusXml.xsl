...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <div class="note">
          <h3>Status</h3>
          <b>Date created:</b> <xsl:value-of select="Run/dateCreated"/><br/>
          <b>Date started:</b> <xsl:value-of select="Run/dateStarted"/><br/>
          <b>Date completed:</b> <xsl:value-of select="Run/dateCompleted"/><br/>
