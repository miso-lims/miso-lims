      ...
      <div class="panel panel-primary panel-login span7">
        ...
        <div class="panel-body">
          <ul class="list-group">
            ...
            <li class="list-group-item" style="border:0;height:45px;"><small><span style="width:100px" class="float-left"><input type='checkbox' name='_spring_security_remember_me'/> Stay logged in</span></small><input type="submit" name="login" value="Login &#187;" tabindex="5" class="float-right"/></li>
          </ul>
        </div>
      </div>
