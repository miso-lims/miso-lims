...
<c:if test="${run.id != 0}">
  ...
  <div id="containers">
    <miso:list-section id="list_container" name="${run.platformType.containerName}s"
    target="run_position" items="${runPositions}" alwaysShow="true" config="${partitionConfig}"/>
  </div>
  <div id="partitions">
