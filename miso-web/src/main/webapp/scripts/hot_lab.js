HotTarget.lab = {
  ...
  createColumns : function(config, create, data) {
    return [
        ...
        HotUtils.makeColumnForConstantsList('Institute', true,
            'instituteAlias', 'instituteId', 'id', 'alias', config.institutes,
            true, {}, null), ];
  },
  ...
  bulkActions : [
      {
        ...
        action : function(items) {
          window.location = window.location.origin + '/miso/lab/bulk/edit?' + jQuery
              .param({
        ...
        action : function(items) {
          var deleteNext = function(index) {
            ...
            Utils.ajaxWithDialog('Deleting ' + items[index].alias, 'DELETE',
                '/miso/rest/lab/' + items[index].id, null, function() {
                  deleteNext(index + 1);
                });
          };
          deleteNext(0);
