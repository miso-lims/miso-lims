ListTarget.samplepurpose = {
  ...
  createBulkActions: function(config, projectId) {
    ...
    if (config.isAdmin) {
      actions.push(ListUtils.createBulkDeleteAction('Sample Purposes', 'samplepurposes', Utils.array.getAlias));
    }
    return actions;
  },
  createStaticActions: function(config, projectId) {
    return !config.isAdmin ? []
        : [ListUtils.createStaticAddAction('Sample Purposes', Urls.ui.samplePurposes.bulkCreate, true)];
  },
