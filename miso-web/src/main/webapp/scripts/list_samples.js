      ...
      actions = actions.concat([
          {
            ...
            action : function(items) {
              Utils.showDialog("Get Information Form", "Next", [ {
                ...
                Project.ui.processSampleDeliveryForm(projectId,
                    result.format.value, items.map(Utils.array.getId));
              });
            }
          }, {
            name : "Receive",
          ...
          handler : function() {
            ...
            Utils.showDialog('Create Samples', 'Create', fields, function(
              ...
              window.location = '/miso/sample/bulk/new?' + jQuery.param({
                ...
                projectId : projectId,
                sampleClassId : Constants.isDetailedSample
                    ? result.sampleClass.id : null
              });
            });
          }
        },
        {
          ...
          handler : function() {
            Utils.showDialog("Get Bulk Sample Input Form", "Get Form", [ {
              ...
              Project.ui.downloadBulkSampleInputForm(projectId,
                  result.formType.value);
            });
          }
        }, {
          name : "Import/Export",
  ...
  createColumns : function(config, projectId) {
    return [
            ...
            "alias", 0),
        {
          ...
          "mRender" : ListUtils.render.textFromId(Constants.sampleClasses,
              'alias', "Plain"),
          "bVisible" : "true",
          "bSortable" : false,
          "iSortPriority" : 0
