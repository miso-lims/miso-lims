    ...
    getSections: function(config) {
      return [{
        ...
        fields: [{
          ...
          include: config.includeAccession
        }, {
          title: 'Sample Type',
          data: 'sampleType',
          type: 'dropdown',
        ...
        title: 'Identity',
        include: config.detailedSample && config.sampleCategory === 'Identity',
        fields: [{
        ...
        fields: [{
          ...
          getSource: function() {
            return Constants.subprojects.filter(function(subproject) {
              return subproject.parentProjectId === config.projectId;
          ...
          type: 'read-only',
          include: config.sampleCategory !== 'Identity'
        }, {
        ...
        title: 'Tissue',
        include: config.detailedSample && config.sampleCategory === 'Tissue',
        fields: [{
          title: 'Tissue Origin',
          data: 'tissueOriginId',
          type: 'dropdown',
        ...
        title: 'Slide',
        include: config.detailedSample && config.sampleClass === 'Slide',
        fields: [{
        ...
        title: 'LCM Tube',
        include: config.detailedSample && config.sampleClass === 'LCM Tube',
        fields: [{
        ...
        title: 'Single Cell',
        include: config.detailedSample && config.sampleClass === 'Single Cell',
        fields: [{
        ...
        title: 'Stock',
        include: config.detailedSample && config.sampleCategory === 'Stock',
        fields: [{
          title: 'STR Status',
          data: 'strStatus',
          type: 'dropdown',
          ...
          precision: 14,
          scale: 10,
          include: config.sampleClass === 'Single Cell DNA (stock)'
        }, {
        ...
        title: 'Aliquot',
        include: config.detailedSample && config.sampleCategory === 'Aliquot',
        fields: [{
          title: 'Purpose',
          ...
          precision: 14,
          scale: 10,
          include: config.sampleClass === 'Single Cell DNA (aliquot)'
        }]
      }];
    }
  }
