ListTarget.sampleclass = {
  ...
  createBulkActions: function(config, projectId) {
    return !config.isAdmin ? [] : [ListUtils.createBulkDeleteAction('Sample Classes', 'sampleclasses', Utils.array.getAlias)];
  },
  ...
  createColumns: function(config, projectId) {
    return [ListUtils.labelHyperlinkColumn('Alias', Urls.ui.sampleClasses.edit, Utils.array.getId, 'alias', 1, true), {
      sTitle: 'Category',
