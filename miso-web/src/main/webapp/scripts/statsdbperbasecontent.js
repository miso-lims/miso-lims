...
function readStatsdbperbasecontent(jsonfile) {
  ...
  jQuery("#statschartperbasecontent").html("<button type=\"button\" onClick=jQuery('.lineA').toggle();jQuery('.circleA').toggle();> <b><font color=red>A </font></b></button> " +
  ...
  var m = [80, 160, 200, 160], w = jQuery("#statschartperbasecontent").width() - m[1] - m[3], h = 700 - m[0] - m[2];
  ...
  file = jsonfile.stats;
  data = file;
console.log(jQuery("#statschartperbasecontent").width())
var space = (jQuery("#statschartperbasecontent").width()-30) / data.length;
  ...
  function load() {
    ...
    legendtext.enter().append('svg:text')
            ...
            .attr('y', (percentile.length ) * space)
    ...
    percenttext.enter().append('svg:text')
            ...
            .attr('y', 200)
            .attr('text-anchor', 'middle')
            .attr("transform", "translate(-250,180)rotate(-90)")
            .text(function(d) {
                    return d;
                  });
    ...
    scoretext.enter().append('svg:text')
            ...
            .attr('y', (percentile.length - 1) * space + 20)
            .attr('text-anchor', 'middle')
            .text(function(d, i) {
                    return d.base;
                  });
