    ...
    Fluxion.doAjax(
      ...
      {'doOnSuccess':function(json) {
          ...
          if (jQuery('#projectProgress').val() == 'all' || json.graph.length > 1) {
            Reports.chart.plotHollowPieChart(json.graph, "projectStatusChart");
          }
    ...
    Fluxion.doAjax(
      ...
      {'doOnSuccess':function(json) {
          ...
          if (jQuery('#sampleType').val() == 'all' || json.graph.length > 1) {
            Reports.chart.plotHollowPieChart(json.graph, "sampleStatusChart");
          }
          if (jQuery('#sampleQC').val() == 'all') {
            Reports.chart.plotHollowPieChart(json.qcgraph, "sampleStatusChart");
          }
    ...
    Fluxion.doAjax(
      ...
      {'doOnSuccess':function(json) {
          ...
          if (jQuery('#libraryPlatform').val() == 'all' || json.graph.length > 1) {
            Reports.chart.plotHollowPieChart(json.graph, "libraryStatusChart");
          }
          if (jQuery('#libraryQC').val() == 'all') {
            Reports.chart.plotHollowPieChart(json.qcgraph, "libraryStatusChart");
          }
    ...
    Fluxion.doAjax(
      ...
      {'doOnSuccess':function(json) {
          ...
          if (jQuery('#runStatus').val() == 'all' || json.graph.length > 1) {
            Reports.chart.plotHollowPieChart(json.graph, "runStatusChart");
          }
          if (jQuery('#runPlatform').val() == 'all' || json.platformgraph.length > 1) {
            Reports.chart.plotHollowPieChart(json.platformgraph, "runStatusChart");
          }
