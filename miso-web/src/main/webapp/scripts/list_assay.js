ListTarget.assay = (function() {
  ...
  return {
    ...
    createBulkActions: function(config, projectId) {
      return !config.isAdmin ? [] : [ListUtils.createBulkDeleteAction(TYPE_LABEL, 'assays', function(x) {
    ...
    createColumns: function(config, projectId) {
      return [ListUtils.labelHyperlinkColumn("Alias", Urls.ui.assays.edit, Utils.array.getId, "alias", 1, true), {
        sTitle: 'Version',
        mData: 'version'
      }, {
        sTitle: 'Archived',
