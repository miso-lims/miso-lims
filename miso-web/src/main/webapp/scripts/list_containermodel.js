ListTarget.containermodel = {
  ...
  createBulkActions: function (config, projectId) {
    if (config.isInstrumentModelPage) {
      ...
      if (config.isAdmin) {
        actions.push(
          ListUtils.createBulkDeleteAction("Container Models", "containermodels", function (model) {
                ...
                Utils.showDialog(
                  ...
                  function (output) {
                    Utils.ajaxWithDialog(
                      "Searching...",
                      "GET",
                      Urls.rest.containerModels.search +
                        "?" +
                        Utils.page.param({
                      ...
                      null,
                      function (models, textStatus, xhr) {
      ...
      return config.isAdmin
        ? [
            ListUtils.createStaticAddAction(
              "Container Models",
              Urls.ui.containerModels.bulkCreate,
              true
            ),
          ]
        : [];
