            ...
            Transfer.addItems(
              items.map(function (item) {
                ...
                return {
                  ...
                  name: item.name,
                  alias: item.alias,
                  boxId: item.box ? item.box.id : item.boxId || null,
                  boxAlias: item.box ? item.box.alias : item.boxAlias || null,
                  boxPosition: item.box ? item.boxPosition : item.coordinates || null,
                  received: null,
                  qcPassed: null,
                  qcNote: null,
                };
