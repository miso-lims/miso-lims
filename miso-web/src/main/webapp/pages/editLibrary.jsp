...
<c:if test="${library.id != 0}">
  ...
  <div class="sectionDivider" onclick="Utils.ui.toggleLeftInfo(jQuery('#notes_arrowclick'), 'notes');">Notes
    <c:choose>
      ...
      <div id="notes" class="simplebox">
      </c:when>
      <c:otherwise>
        <div id="notes_arrowclick" class="toggleLeft"></div>
      </div>
      <div id="notes" class="simplebox" style="display:none">
      </c:otherwise>
    </c:choose>
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="notes-menu" class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-float-right" role="menu" aria-labelledby="notedrop1">
...
<c:if test="${library.id != 0}">
<nav id="navbar-libraryqc" class="navbar navbar-default navbar-static" role="navigation">
  <div class="navbar-header">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li id="qc-menu" class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-float-right" role="menu" aria-labelledby="qcdrop1">
          <li role="presentation">
            <a onclick="Library.qc.insertLibraryQCRow(${library.id});" href='javascript:void(0);' class="add">Add Library QC</a>
          </li>
        </ul>
      </li>
    </ul>
...
<nav id="navbar-libdil" class="navbar navbar-default navbar-static" role="navigation">
  <div class="navbar-header">
  ...
  <div class="collapse navbar-collapse bs-example-js-navbar-collapse">
    <ul class="nav navbar-nav navbar-right">
      <li id="ld-menu" class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-float-right" role="menu" aria-labelledby="lddrop1">
          <li role="presentation">
            <a href='javascript:void(0);' class="add" onclick="Library.dilution.insertLibraryDilutionRow(${library.id});">
...
<c:if test="${library.platformName ne 'Illumina'}">
  ...
  <nav id="navbar-empcrqc" class="navbar navbar-default navbar-static" role="navigation">
    <div class="navbar-header">
    ...
    <div class="collapse navbar-collapse bs-example-js-navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        <li id="lp-menu" class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-float-right" role="menu" aria-labelledby="lpdrop1">
            <li role="presentation">
