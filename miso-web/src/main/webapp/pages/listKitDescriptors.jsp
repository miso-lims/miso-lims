    ...
    <table class="list" id="table1">
        ...
        <c:forEach items="${sequencing}" var="sequencing">
            <tr onMouseOver="this.className='highlightrow'" onMouseOut="this.className='normalrow'">
                ...
                <td class="misoicon"
                    onclick="window.location.href='<c:url value="/miso/kitdescriptor/${sequencing.kitDescriptorId}"/>'"><span class="ui-icon ui-icon-pencil"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <table class="list" id="table2">
        ...
        <c:forEach items="${empcr}" var="empcr">
            <tr onMouseOver="this.className='highlightrow'" onMouseOut="this.className='normalrow'">
                ...
                <td class="misoicon"
                    onclick="window.location.href='<c:url value="/miso/kitdescriptor/${empcr.kitDescriptorId}"/>'"><span class="ui-icon ui-icon-pencil"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <table class="list" id="table3">
        ...
        <c:forEach items="${library}" var="library">
            <tr onMouseOver="this.className='highlightrow'" onMouseOut="this.className='normalrow'">
                ...
                <td class="misoicon"
                    onclick="window.location.href='<c:url value="/miso/kitdescriptor/${library.kitDescriptorId}"/>'"><span class="ui-icon ui-icon-pencil"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <table class="list" id="table4">
        ...
        <c:forEach items="${clustering}" var="clustering">
            <tr onMouseOver="this.className='highlightrow'" onMouseOut="this.className='normalrow'">
                ...
                <td class="misoicon"
                    onclick="window.location.href='<c:url value="/miso/kitdescriptor/${clustering.kitDescriptorId}"/>'"><span class="ui-icon ui-icon-pencil"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <table class="list" id="table5">
        ...
        <c:forEach items="${multiplexing}" var="multiplexing">
            <tr onMouseOver="this.className='highlightrow'" onMouseOut="this.className='normalrow'">
                ...
                <td class="misoicon"
                    onclick="window.location.href='<c:url value="/miso/kitdescriptor/${multiplexing.kitDescriptorId}"/>'"><span class="ui-icon ui-icon-pencil"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
