...
<table border="0">
    <tr>
        <td>Plate Barcode:</td>
        <td><input type="text" size="20" name="platebarcode"/></td>
    </tr>
    <tr>
        <td>Paired:</td>
    ...
    <tr>
        <td>Platforms:</td>
        <td><select name="platforms" id="platforms">
    ...
    <tr>
        <td>Selections:</td>
        <td><select name="selections" id="selections">
    ...
    <tr>
        <td>Strategies:</td>
        <td><select name="strategies" id="strategies">
            <option>WGS</option>
            <option>WGA</option>
            <option>WXS</option>
