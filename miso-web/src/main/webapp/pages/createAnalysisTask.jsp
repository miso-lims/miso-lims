...
<h1>
  New Analysis Task
  <input type="button" value="Submit Task" class="fg-button ui-state-default ui-corner-all" onclick="submitAnalysisTask();"/>
</h1>
...
<form:form id="taskForm" method="POST" autocomplete="off">
  ...
  <div id="pipelines" style="padding-top:6px">
    Pipeline: <select name='pipeline' id='pipeline' onchange='selectPipeline(this<c:if test="${not empty run}">, ${run.runId}</c:if>);'>
