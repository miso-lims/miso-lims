...
public enum LibraryAliquotSpreadSheets implements Spreadsheet<LibraryAliquot> {
  TRACKING_LIST("Tracking List", //
      ...
      Column.forString("Library Design", libraryAliquot -> LimsUtils.isDetailedLibraryAliquot(libraryAliquot)? ((DetailedLibraryAliquot)libraryAliquot).getLibraryDesignCode().toString(): ""), //
