 ...
 * @since 0.1.2
 */
public class LibraryPreparationCompleteResponderService extends AbstractResponderService<ProjectOverviewEvent> {
  ...
  public boolean respondsTo(ProjectOverviewEvent event) {
    ...
    if (event.getEventType().equals(MisoEventType.LIBRARY_PREPARATION_COMPLETED) && po.getLibraryPreparationComplete()) {
