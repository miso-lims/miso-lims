 ...
 * @since 0.1.2
 */
public class PoolConstructionCompleteResponderService implements ResponderService<ProjectOverviewEvent> {
  ...
  public boolean respondsTo(ProjectOverviewEvent event) {
    ...
    if (event.getEventType().equals(MisoEventType.POOL_CONSTRUCTION_COMPLETE) && po.getAllPoolsConstructed()) {
      return true;
    }
    return false;
  }
