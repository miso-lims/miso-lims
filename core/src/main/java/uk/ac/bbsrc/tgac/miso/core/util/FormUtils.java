        ...
        if (!"".equals(sampleAliasCell.getStringValue())) {
          ...
          if (!ss.isEmpty()) {
            if (ss.size() == 1) {
              ...
              throw new InputFormException("Multiple samples retrieved with this alias: '" + sampleAliasCell.getStringValue()
                  + "'. Cannot process.");
            }
          } else {
        ...
        if (s != null) {
          ...
          if (!"".equals(sampleQcCell.getStringValue())) {
            try {
              ...
              throw new InputFormException("Supplied Sample QC concentration for sample '" + sampleAliasCell.getStringValue()
                  + "' is invalid", nfe);
            }
          }
              ...
              if (!"".equals(libraryQcMolarityCell.getStringValue())) {
                ...
                try {
                  ...
                  if (m.matches()) {
                    ...
                    throw new InputFormException("Supplied Library insert size for library '" + libAlias + "' (" + s.getAlias()
                        + ") is invalid");
                  }
                } catch (NumberFormatException nfe) {
                  throw new InputFormException("Supplied Library insert size for library '" + libAlias + "' (" + s.getAlias()
                ...
                try {
                  ...
                  throw new InputFormException("Supplied Library QC concentration for library '" + libAlias + "' (" + s.getAlias()
                      + ") is invalid", nfe);
                }
              }
              ...
              if (!"".equals(barcodeKitCell.getStringValue())) {
                ...
                if (!bcs.isEmpty()) {
                  ...
                  if (!"".equals(tags)) {
                    ...
                    throw new InputFormException("Barcode Kit specified but no tag barcodes entered for: '"
                        + sampleAliasCell.getStringValue() + "'.");
                  }
                } else {
              ...
              if (!"".equals(poolConvertedMolarityCell.getStringValue())) {
                ...
                if (p != null) {
                  ...
                  try {
                    ...
                    throw new InputFormException("Supplied pool concentration for pool '" + poolNumberCell.getStringValue()
                        + "' is invalid", nfe);
                  }
                }
              }
      ...
      for (int ri = 5; ri < rows; ri++) {
        ...
        if (s != null) {
          ...
          try {
            ...
            throw new InputFormException("Supplied Sample QC concentration for sample '" + getCellValueAsString(sampleAliasCell)
                + "' is invalid", nfe);
          }
            ...
            if (mat.matches()) {
              ...
              if (getCellValueAsString(dilutionMolarityCell) != null) {
                try {
                  ...
                  throw new InputFormException("Supplied LibraryDilution concentration for library '" + libAlias + "' (" + s.getAlias()
                      + ") is invalid", nfe);
                }
              }
