        ...
        if (s != null) {
          ...
          if (barcodeKitCell.getStringValue() != null && barcodeTagsCell.getStringValue() != null) {
            ...
            if (mat.matches()) {
               ...
               * nfe) { throw new InputFormException("Supplied LibraryDilution concentration for library '"+libAlias+"' ("+s.getAlias()+
               * ") is invalid", nfe); } }
               */
      ...
      if (s != null) {
        ...
        if (getCellValueAsString(barcodeKitCell) != null && getCellValueAsString(barcodeTagsCell) != null) {
          ...
          if (mat.matches()) {
             ...
             * (NumberFormatException nfe) { throw new InputFormException("Supplied LibraryDilution concentration for library '"+libAlias+
