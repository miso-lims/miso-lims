...
public class SQLEmPCRDAO implements EmPCRStore {
  ...
  public static final String EMPCR_UPDATE = "UPDATE "
      + TABLE_NAME
  ...
  @TriggersRemove(cacheName = { "emPCRCache", "lazyEmPCRCache" }, keyGenerator = @KeyGenerator(name = "HashCodeCacheKeyGenerator", properties = {
