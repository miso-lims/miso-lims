...
DROP TABLE IF EXISTS `lims`.`KitDescriptor`;
CREATE TABLE  `lims`.`KitDescriptor` (
...
INSERT INTO `lims`.`KitDescriptor` (`kitDescriptorId`,`name`,`version`,`manufacturer`,`partNumber`,`stockLevel`,`kitType`,`platformType`) VALUES 
...
DROP TABLE IF EXISTS `lims`.`LibrarySelectionType`;
CREATE TABLE  `lims`.`LibrarySelectionType` (
  `librarySelectionTypeId` bigint(20) NOT NULL auto_increment,
  `name` varchar(50) NOT NULL,
  `description` varchar(255) NOT NULL,
  PRIMARY KEY  (`librarySelectionTypeId`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8;
INSERT INTO `lims`.`LibrarySelectionType` (`librarySelectionTypeId`,`name`,`description`) VALUES 
...
DROP TABLE IF EXISTS `lims`.`LibraryStrategyType`;
CREATE TABLE  `lims`.`LibraryStrategyType` (
  `libraryStrategyTypeId` bigint(20) NOT NULL auto_increment,
  `name` varchar(50) NOT NULL,
  `description` varchar(255) NOT NULL,
  PRIMARY KEY  (`libraryStrategyTypeId`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;
INSERT INTO `lims`.`LibraryStrategyType` (`libraryStrategyTypeId`,`name`,`description`) VALUES 
...
DROP TABLE IF EXISTS `lims`.`LibraryType`;
CREATE TABLE  `lims`.`LibraryType` (
  `libraryTypeId` bigint(20) NOT NULL auto_increment,
  `description` varchar(255) NOT NULL,
  `platformType` varchar(50) NOT NULL,
  PRIMARY KEY  (`libraryTypeId`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;
INSERT INTO `lims`.`LibraryType` (`libraryTypeId`,`description`,`platformType`) VALUES 
 (16,'Small RNA','Solid'),
...
DROP TABLE IF EXISTS `lims`.`Platform`;
CREATE TABLE  `lims`.`Platform` (
...
INSERT INTO `lims`.`Platform` (`platformId`,`name`,`instrumentModel`,`description`,`numContainers`) VALUES 
...
DROP TABLE IF EXISTS `lims`.`QCType`;
CREATE TABLE  `lims`.`QCType` (
...
INSERT INTO `lims`.`QCType` (`qcTypeId`,`name`,`description`,`qcTarget`,`units`) VALUES 
...
DROP TABLE IF EXISTS `lims`.`SampleType`;
CREATE TABLE  `lims`.`SampleType` (
  `typeId` bigint(20) NOT NULL auto_increment,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY  (`typeId`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
INSERT INTO `lims`.`SampleType` (`typeId`,`name`) VALUES 
 (2,'NON GENOMIC'),
 (1,'GENOMIC'),
 (5,'OTHER'),
 (4,'VIRAL RNA'),
...
DROP TABLE IF EXISTS `lims`.`StudyType`;
CREATE TABLE  `lims`.`StudyType` (
  `typeId` bigint(20) NOT NULL auto_increment,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY  (`typeId`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
INSERT INTO `lims`.`StudyType` (`typeId`,`name`) VALUES 
 (1,'Other'),
 (12,'RNASeq'),
...
DROP TABLE IF EXISTS `lims`.`TagBarcodes`;
CREATE TABLE  `lims`.`TagBarcodes` (
...
INSERT INTO `lims`.`TagBarcodes` (`tagId`,`name`,`sequence`,`platformName`,`strategyName`) VALUES 
...
DROP TABLE IF EXISTS `lims`.`_Group`;
CREATE TABLE  `lims`.`_Group` (
  `groupId` bigint(20) NOT NULL auto_increment,
  `description` varchar(255) default NULL,
  `name` varchar(255) default NULL,
  PRIMARY KEY  (`groupId`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
INSERT INTO `lims`.`_Group` (`groupId`,`description`,`name`) VALUES 
...
INSERT INTO `lims`.`User` (`active`,`admin`, `external`, `fullName`, `internal`, `loginName`, `roles`, `password`, `email`) VALUES
 (1, 1, 0, 'admin', 1, 'admin', 'ROLE_ADMIN,ROLE_INTERNAL', SHA('admin'), 'admin@admin');
