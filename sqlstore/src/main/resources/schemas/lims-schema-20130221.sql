...
CREATE TABLE `PrintService` (
  ...
  `contextFields` text CHARACTER SET utf8,
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Information about a project proposal';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-02-21 17:21:12
