...
ALTER TABLE Sample MODIFY COLUMN cellViability DECIMAL(16,10);
ALTER TABLE Sample MODIFY COLUMN loadingCellConcentration DECIMAL(16,10);
ALTER TABLE Sample MODIFY COLUMN inputIntoLibrary DECIMAL(16,10);
...
ALTER TABLE Library MODIFY COLUMN spikeInVolume DECIMAL(16,10);
