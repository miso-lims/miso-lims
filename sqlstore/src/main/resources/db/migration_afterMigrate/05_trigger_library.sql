...
FOR EACH ROW
  ...
  SET log_message = CONCAT_WS(', ',
        ...
        CASE WHEN NEW.lowQuality <> OLD.lowQuality THEN CONCAT('low quality: ', CASE WHEN OLD.lowQuality THEN 'yes' ELSE 'no' END, END, ' → ', CASE WHEN NEW.lowQuality THEN 'yes' ELSE 'no' END) END,
