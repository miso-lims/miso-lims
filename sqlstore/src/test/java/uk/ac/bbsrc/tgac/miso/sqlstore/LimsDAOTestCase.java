...
public abstract class LimsDAOTestCase extends DatabaseTestCase {
  ...
  private static final String[] tables = { "Alert", "EntityGroup", "EntityGroup_Elements", "Experiment", "Experiment_Kit", "Kit",
      ...
      "Pool_Experiment", "PrintJob", "PrintService", "Project", "ProjectOverview", "ProjectOverview_Note", "Project_Issues",
      "Project_Note", "Project_ProjectOverview", "Project_Request", "Project_Study", "QCType", "Request", "Request_Note", "Run", "RunQC",
      "RunQC_Partition", "Run_Note", "Sample", "SampleQC", "SampleType", "Sample_Note", "SecurityProfile", "SecurityProfile_ReadGroup",
  ...
  private static void createDatabase(Connection conn) throws Exception {
    ...
    runStatement(conn, "CREATE TABLE Alert (" + "alertId BIGINT NOT NULL," + "title VARCHAR(100) NOT NULL," + "text LONGVARCHAR NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE Experiment (" + "experimentId BIGINT NOT NULL, " + "name VARCHAR(255) NOT NULL, "
    ...
    runStatement(conn, "CREATE TABLE Kit (" + "kitId BIGINT NOT NULL," + "identificationBarcode VARCHAR(255) default NULL,"
    ...
    runStatement(conn, "CREATE TABLE KitDescriptor (" + "kitDescriptorId BIGINT NOT NULL," + "name VARCHAR(255) default NULL,"
    ...
    runStatement(conn, "CREATE TABLE Library (" + "libraryId BIGINT NOT NULL," + "name VARCHAR(255) NOT NULL,"
        + "description VARCHAR(255) NOT NULL," + "accession VARCHAR(30) default NULL," + "securityProfile_profileId BIGINT default NULL,"
        + "sample_sampleId BIGINT NOT NULL," + "identificationBarcode VARCHAR(255) default NULL,"
        + "locationBarcode VARCHAR(255) default NULL," + "libraryType BIGINT default NULL," + "librarySelectionType BIGINT default NULL,"
        + "libraryStrategyType BIGINT default NULL," + "concentration TINYINT default NULL," + "creationDate TIMESTAMP NOT NULL,"
        + "platformName VARCHAR(255) default NULL," + "alias VARCHAR(30) default NULL," + "paired BIT NOT NULL,"
        + "qcPassed VARCHAR(5) default NULL," + "PRIMARY KEY  (libraryId)" + ");");

    runStatement(conn, "CREATE TABLE LibraryDilution (" + "dilutionId BIGINT NOT NULL," + "concentration DOUBLE NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE LibraryQC (" + "qcId BIGINT NOT NULL," + "library_libraryId BIGINT NOT NULL,"
        + "qcUserName VARCHAR(255) NOT NULL," + "qcDate TIMESTAMP NOT NULL," + "qcMethod BIGINT NOT NULL," + "results DOUBLE default NULL,"
        + "insertSize INT NOT NULL," + "PRIMARY KEY (qcId)" + ");");
    ...
    runStatement(conn, "CREATE TABLE Library_TagBarcode (" + "library_libraryId BIGINT NOT NULL," + "barcode_barcodeId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE Note (" + "noteId BIGINT NOT NULL, " + "creationDate DATE default NULL, "
        + "internalOnly BIT NOT NULL, " + "text VARCHAR(255) default NULL, " + "owner_userId BIGINT default NULL, "
        + "PRIMARY KEY (noteId)" + ");");
    ...
    runStatement(conn, "CREATE TABLE Plate (" + "plateId BIGINT NOT NULL," + "name VARCHAR(255) NOT NULL,"
        + "description VARCHAR(255) NOT NULL," + "creationDate DATE NOT NULL," + "plateMaterialType VARCHAR(20) NOT NULL,"
        + "identificationBarcode VARCHAR(255) DEFAULT NULL," + "locationBarcode VARCHAR(255) DEFAULT NULL," + "size INT NOT NULL,"
        + "tagBarcodeId BIGINT DEFAULT NULL," + "securityProfile_profileId BIGINT default NULL," + "PRIMARY KEY (plateId) " + ");");
    ...
    runStatement(conn, "CREATE TABLE Pool (" + "poolId BIGINT NOT NULL," + "concentration DOUBLE NOT NULL,"
        + "identificationBarcode VARCHAR(13) default NULL," + "name VARCHAR(255) NOT NULL," + "alias VARCHAR(50) default NULL,"
        + "creationDate DATE NOT NULL," + "securityProfile_profileId BIGINT default NULL," + "experiment_experimentId BIGINT default NULL,"
        + "platformType VARCHAR(20) NOT NULL," + "ready BOOLEAN NOT NULL," + "qcPassed VARCHAR(5) default NULL," + "PRIMARY KEY  (poolId)"
        + ");");

    runStatement(conn, "CREATE TABLE PoolQC (" + "qcId BIGINT NOT NULL," + "pool_poolId BIGINT NOT NULL,"
        + "qcUserName VARCHAR(255) NOT NULL," + "qcDate TIMESTAMP NOT NULL," + "qcMethod BIGINT NOT NULL," + "results DOUBLE default NULL,"
        + "PRIMARY KEY (qcId)" + ");");

    runStatement(conn, "CREATE TABLE Pool_Experiment (" + "pool_poolId BIGINT NOT NULL," + "experiments_experimentId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE Pool_Elements (" + "pool_poolId BIGINT NOT NULL," + "elementType VARCHAR(255) NOT NULL"
        + "elementId BIGINT NOT NULL" + ");");

    runStatement(conn, "CREATE TABLE Platform (" + "platformId BIGINT NOT NULL," + "name VARCHAR(50) NOT NULL,"
        + "instrumentModel VARCHAR(100) NOT NULL," + "description VARCHAR(255) NOT NULL," + "numContainers TINYINT NOT NULL,"
        + "PRIMARY KEY  (platformId)" + ");");

    runStatement(conn, "CREATE TABLE PrintJob (" + "jobId BIGINT NOT NULL," + "printServiceName VARCHAR(255) NOT NULL,"
        + "printDate TIMESTAMP NOT NULL," + "jobCreator_userId BIGINT NOT NULL," + "printedElements BINARY NOT NULL,"
        + "status VARCHAR(20) NOT NULL," + "PRIMARY KEY (jobId));");

    runStatement(conn, "CREATE TABLE PrintService (" + "serviceId BIGINT NOT NULL," + "serviceName VARCHAR(100) NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE Project (" + "projectId BIGINT NOT NULL," + "creationDate TIMESTAMP default NULL,"
    ...
    runStatement(conn, "CREATE TABLE ProjectOverview_Note (" + "overview_overviewId BIGINT NOT NULL," + "notes_noteId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE Project_Note (" + "project_projectId BIGINT NOT NULL," + "notes_noteId BIGINT NOT NULL" + ");");

    runStatement(conn, "CREATE TABLE Project_ProjectOverview (" + "project_projectID BIGINT NOT NULL,"
        + "overviews_overviewId BIGINT NOT NULL" + ");");

    runStatement(conn, "CREATE TABLE Project_Request (" + "Project_projectId BIGINT NOT NULL," + "requests_requestId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE Project_Study (" + "Project_projectId BIGINT NOT NULL," + "studies_studyId BIGINT NOT NULL" + ");");

    runStatement(conn, "CREATE TABLE QcType (" + "qcTypeId BIGINT NOT NULL," + "name VARCHAR(255) NOT NULL,"
        + "description VARCHAR(255) NOT NULL," + "qcTarget VARCHAR(50) NOT NULL," + "units VARCHAR(10) NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE RunQC (" + "qcId BIGINT NOT NULL," + "run_runId BIGINT NOT NULL,"
        + "qcUserName VARCHAR(255) NOT NULL," + "qcDate TIMESTAMP NOT NULL," + "qcMethod BIGINT NOT NULL,"
        + "information LONGVARCHAR default NULL," + "doNotProcess BIT NOT NULL," + "PRIMARY KEY (qcId)" + ");");
    ...
    runStatement(conn, "CREATE TABLE Run_SequencerPartitionContainer (" + "Run_runId BIGINT NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE Sample (" + "sampleId BIGINT NOT NULL," + "accession VARCHAR(50) default NULL,"
        + "name VARCHAR(255) NOT NULL," + "description VARCHAR(255) NOT NULL," + "scientificName VARCHAR(255) NOT NULL,"
        + "taxonIdentifier VARCHAR(255) default NULL," + "securityProfile_profileId BIGINT default NULL,"
        + "identificationBarcode VARCHAR(255) default NULL," + "locationBarcode VARCHAR(255) default NULL,"
        + "sampleType VARCHAR(50) NOT NULL," + "receivedDate TIMESTAMP default NULL," + "qcPassed VARCHAR(5) default NULL,"
        + "alias VARCHAR(30) default NULL," + "project_projectId BIGINT NOT NULL," + "PRIMARY KEY  (sampleId)" + ");");

    runStatement(conn, "CREATE TABLE SampleQC (" + "qcId BIGINT NOT NULL," + "sample_sampleId BIGINT NOT NULL,"
        + "qcUserName VARCHAR(255) NOT NULL," + "qcDate TIMESTAMP NOT NULL," + "qcMethod BIGINT NOT NULL," + "results DOUBLE default NULL,"
        + "PRIMARY KEY (qcId)" + ");");

    runStatement(conn, "CREATE TABLE SampleType (" + "typeId BIGINT NOT NULL," + "name VARCHAR(255) NOT NULL," + "PRIMARY KEY (typeId)"
        + ");");
    ...
    runStatement(conn, "CREATE TABLE SequencerPartitionContainer (" + "containerId BIGINT NOT NULL," + "platform BIGINT DEFAULT NULL,"
    ...
    runStatement(conn, "CREATE TABLE Status (" + "statusId BIGINT NOT NULL," + "health VARCHAR(50) NOT NULL,"
        + "completionDate DATE default NULL," + "startDate DATE default NULL," + "xml BINARY default NULL,"
        + "runName VARCHAR(255) default NULL," + "instrumentName VARCHAR(255) default NULL,"
        + "lastUpdated TIMESTAMP default CURRENT_TIMESTAMP, " + "PRIMARY KEY (statusId)" + ");");

    runStatement(conn, "CREATE TABLE Study (" + "studyId BIGINT NOT NULL," + "name VARCHAR(255) NOT NULL,"
        + "description VARCHAR(255) NOT NULL," + "accession VARCHAR(30) default NULL," + "securityProfile_profileId BIGINT default NULL,"
        + "project_projectId BIGINT NOT NULL," + "studyType VARCHAR(255) default NULL," + "alias VARCHAR(30) default NULL,"
        + "PRIMARY KEY  (studyId)" + ");");

    runStatement(conn, "CREATE TABLE StudyType (" + "typeId BIGINT NOT NULL," + "name VARCHAR(255) NOT NULL," + "PRIMARY KEY (typeId)"
        + ");");

    runStatement(conn, "CREATE TABLE Study_Experiment (" + "Study_studyId BIGINT NOT NULL," + "experiments_experimentId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE Submission (" + "submissionId BIGINT NOT NULL," + "creationDate DATE NOT NULL,"
        + "submittedDate DATE DEFAULT NULL," + "verified BIT NOT NULL," + "description VARCHAR(255)," + "name VARCHAR(255),"
        + "title VARCHAR(255)," + "accession VARCHAR(50) DEFAULT NULL," + "alias VARCHAR(30) DEFAULT NULL," + "completed BIT NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE Submission_Partition_Dilution (" + "submission_submissionId BIGINT NOT NULL,"
    ...
    runStatement(conn, "CREATE TABLE Submission_Sample (" + "submission_submissionId BIGINT NOT NULL," + "samples_sampleId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE Submission_Study (" + "submission_submissionId BIGINT NOT NULL," + "studies_studyId BIGINT NOT NULL"
        + ");");

    runStatement(conn, "CREATE TABLE TagBarcodes (" + "tagId BIGINT NOT NULL," + "name VARCHAR(10) NOT NULL,"
        + "sequence VARCHAR(20) NOT NULL," + "platformName VARCHAR(20) NOT NULL," + "strategyName VARCHAR(100) NOT NULL,"
        + "PRIMARY KEY  (tagId)" + ");");

    runStatement(conn, "CREATE TABLE User (" + "userId BIGINT NOT NULL," + "active BIT NOT NULL," + "admin BIT NOT NULL,"
        + "external BIT NOT NULL," + "fullName VARCHAR(255) default NULL," + "internal BIT NOT NULL,"
        + "loginName VARCHAR(255) default NULL," + "roles BINARY," + "password VARCHAR(255) default NULL,"
        + "email VARCHAR(255) default NULL," + "PRIMARY KEY  (userId)" + ");");
    ...
    runStatement(conn, "CREATE TABLE emPCR (" + "pcrId BIGINT NOT NULL," + "concentration DOUBLE NOT NULL,"
        + "dilution_dilutionId BIGINT NOT NULL," + "creationDate DATE NOT NULL," + "pcrUserName VARCHAR(255) NOT NULL,"
        + "name VARCHAR(255) NOT NULL," + "securityProfile_profileId BIGINT default NULL," + "PRIMARY KEY  (pcrId)" + ");");

    runStatement(conn, "CREATE TABLE emPCRDilution (" + "dilutionId BIGINT NOT NULL," + "concentration DOUBLE NOT NULL,"
        + "emPCR_pcrId BIGINT NOT NULL," + "identificationBarcode VARCHAR(255) default NULL," + "creationDate DATE NOT NULL,"
        + "dilutionUserName VARCHAR(255) NOT NULL," + "name VARCHAR(255) NOT NULL," + "securityProfile_profileId BIGINT default NULL,"
        + "PRIMARY KEY  (dilutionId)" + ");");
