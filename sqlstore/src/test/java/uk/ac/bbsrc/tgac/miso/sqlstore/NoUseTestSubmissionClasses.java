...
public class NoUseTestSubmissionClasses extends LimsDAOTestCase {
   ...
   * lsts=getLibraryDAO().listAllLibraryStrategyTypes(); for(LibraryStrategyType l:lsts){
  ...
  public void test() {
    try {
       ...
       * 
       * PlatformType platform = run.getPlatformType(); System.out.println("Platform:" + platform);
