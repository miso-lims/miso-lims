...
@Suite.SuiteClasses({ SQLAlertDAOTest.class, SQLLibraryQCDAOTest.class, SQLRunDAOTest.class, SQLPoolQCDAOTest.class, SQLStatusDAOTest.class,
    ...
    SQLLibraryDAOTest.class, SQLLibraryDilutionDAOTest.class })
