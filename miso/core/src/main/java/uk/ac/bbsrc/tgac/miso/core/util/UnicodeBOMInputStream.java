...
/**
 * The <code>UnicodeBOMInputStream</code> class wraps any <code>InputStream</code> and detects the presence of any Unicode BOM (Byte Order
 * Mark) at its beginning, as defined by <a href="http://www.faqs.org/rfcs/rfc3629.html">RFC 3629 - UTF-8, a transformation format of ISO
 * 10646</a>
 * 
 * <p>
 * The <a href="http://www.unicode.org/unicode/faq/utf_bom.html">Unicode FAQ</a> defines 5 types of BOMs:
 * <ul>
 * <li>
 * 
 * <pre>
 ...
 * </p>
 * <p>
 * Use the {@link #skipBOM()} method to remove the detected BOM from the wrapped <code>InputStream</code> object.
 * </p>
 */
public class UnicodeBOMInputStream extends InputStream {
   ...
   * @throws IOException
   *           on reading from the specified <code>InputStream</code> when trying to detect the Unicode BOM.
   */
  public UnicodeBOMInputStream(final InputStream inputStream) throws NullPointerException, IOException

  {
    if (inputStream == null) throw new NullPointerException("invalid input stream: null is not allowed");
