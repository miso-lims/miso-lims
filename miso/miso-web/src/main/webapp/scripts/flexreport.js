...
var Reports = Reports || {
  generateProjectsFlexReport: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'generateProjectsFlexReport', {
      'form': jQuery('#generateProjectsFlexReportForm').serializeArray(),
      'url': ajaxurl
    }, {
  ...
  generateProjectRunLaneFlexReport: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'generateProjectRunLaneFlexReport', {
      'form': jQuery('#generateProjectRunLaneFlexReportForm').serializeArray(),
      'url': ajaxurl
    }, {
      'doOnSuccess': function(json) {
  ...
  generateSampleRelationReport: function() {
    ...
    jQuery('#generateProjectRunLaneFlexReportFormHeader').html('<img src=\"/styles/images/ajax-loader.gif\"/>');
    Fluxion.doAjax('flexReportingControllerHelperService', 'generateSampleRelationReport', {
      'form': jQuery('#generateProjectRunLaneFlexReportForm').serializeArray(),
      'url': ajaxurl
    }, {
      'doOnSuccess': function(json) {
  ...
  generateSamplesFlexReport: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'generateSamplesFlexReport', {
      'form': jQuery('#generateSamplesFlexReportForm').serializeArray(),
      'url': ajaxurl
    }, {
      'doOnSuccess': function(json) {
  ...
  generateLibrariesFlexReport: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'generateLibrariesFlexReport', {
      'form': jQuery('#generateLibrariesFlexReportForm').serializeArray(),
      'url': ajaxurl
    }, {
      'doOnSuccess': function(json) {
  ...
  generateRunsFlexReport: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'generateRunsFlexReport', {
      'form': jQuery('#generateRunsFlexReportForm').serializeArray(),
      'url': ajaxurl
    }, {
      'doOnSuccess': function(json) {
...
Reports.ui = {
  ...
  initProjects: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'initProjects', {
      'url': ajaxurl
    }, {
      "doOnSuccess": function(json) {
  ...
  initSamples: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'initSamples', {
      'url': ajaxurl
    }, {
      "doOnSuccess": function(json) {
  ...
  initLibraries: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'initLibraries', {
      'url': ajaxurl
    }, {
      "doOnSuccess": function(json) {
  ...
  initRuns: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'initRuns', {
      'url': ajaxurl
    }, {
      "doOnSuccess": function(json) {
  ...
  createProjectFormTable: function(array) {
    jQuery('#projectsResultTable').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="projectsResultFormTable"></table>');
    jQuery('#projectsResultFormTable')
        .dataTable(
            {
              "aaData": array,
              "aoColumns": [
  ...
  createProjectRunLaneFormTable: function(array) {
    jQuery('#projectRunLaneResultTable').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="projectRunLaneResultFormTable"></table>');
  ...
  createSampleFormTable: function(array) {
    jQuery('#samplesResultTable').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="samplesResultFormTable"></table>');
    jQuery('#samplesResultFormTable')
        .dataTable(
            {
              "aaData": array,
              "aoColumns": [
  ...
  createLibraryFormTable: function(array) {
    jQuery('#librariesResultTable').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="librariesResultFormTable"></table>');
    jQuery('#librariesResultFormTable')
        .dataTable(
            {
              "aaData": array,
              "aoColumns": [
  ...
  createProjectOverviewTable: function(array) {
    ...
    jQuery('#projectOverviewCell').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="projectOverviewTable"></table>');
  ...
  createProjectResultTable: function(array) {
    ...
    jQuery('#projectsFlexReport').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="projectsFlexReportTable"></table>');
  ...
  createProjectDetailTable: function(array) {
    ...
    jQuery('#projectsDetailReport').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="projectsDetailReportTable"></table>');
  ...
  createProjectRunLaneResultTable: function(array) {
    ...
    jQuery('#projectRunLaneFlexReport').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="projectRunLaneFlexReportTable"></table>');
  ...
  createSampleOverviewRelationTable: function(array) {
    ...
    jQuery('#sampleOverviewCell').append(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="sampleOverviewRelationTable"></table>');
  ...
  createSampleOverviewTable: function(array) {
    jQuery('#sampleOverviewFlexReportTable').css("visibility", "visible");
    jQuery('#sampleOverviewCell').append(
        '<br/><br/><table cellpadding="0" cellspacing="0" border="0" class="display" id="sampleOverviewTable"></table>');
  ...
  createSampleResultTable: function(array) {
    ...
    jQuery('#samplesFlexReport').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="samplesFlexReportTable"></table>');
  ...
  createLibraryOverviewRelationTable: function(array) {
    ...
    jQuery('#libraryOverviewCell').append(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="libraryOverviewRelationTable"></table>');
  ...
  createLibraryRelationQCTable: function(array) {
    ...
    jQuery('#librariesRelationQC').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="librariesRelationQCTable"></table>');
  ...
  createLibraryOverviewTable: function(array) {
    jQuery('#libraryOverviewFlexReportTable').css("visibility", "visible");
    jQuery('#libraryOverviewCell').append(
        '<br/><br/><table cellpadding="0" cellspacing="0" border="0" class="display" id="libraryOverviewTable"></table>');
  ...
  createLibraryResultTable: function(array) {
    ...
    jQuery('#librariesFlexReport').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="librariesFlexReportTable"></table>');
  ...
  createRunsPartitionReport: function(array) {
    ...
    jQuery('#runsPartitionReport').html(
        '<table cellpadding="0" cellspacing="0" border="0" class="display" id="runsPartitionReportTable"></table>');
  ...
  getSequencersList: function() {
    var self = this;
    Fluxion.doAjax('sequencerReferenceControllerHelperService', 'listSequencers', {
      'url': ajaxurl
    }, {
      'doOnSuccess': function(json) {
        ...
        for (var i = 0; i < json.sequencers.length; i++) {
          list += "<option value=" + json.sequencers[i].id + ">" + json.sequencers[i].name_model + " - " + json.sequencers[i].name
              + "</option>";
        }
  ...
  generateColors: function() {
    ...
    var color = "<table>";
    var tempcolour = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5",
    ...
    for (var i = 1; i < size; i++) {
      ...
      color += "<td bgcolor=" + tempcolour[jQuery("#sequencers option").eq(i).val()] + "> <font color='black'> <b> " + label
          + "</b> </font></td>";
      if ((i % 2) === 0) {
        color += "</tr>";
      }
...
Reports.chart = {
  plotPieChart: function(datachart, div) {
    ...
    var vis = d3.select("#" + div).append("svg:svg").data([datachart]).attr("width", w).attr("height", h).append("svg:g").attr("transform",
        "translate(" + r + "," + r + ")");
    ...
    arcs.append("svg:path").attr("fill", function(d, i) {
      return color(i);
    }).attr("d", arc).append("svg:title").text(function(d, i) {
  ...
  plotHollowPieChart: function(data, div) {
    ...
    var vis = d3.select("#" + div).append("svg:svg").data([data]).attr("width", w + 150).attr("height", h);

    var arcs = vis.selectAll("g.arc").data(donut.value(function(d) {
      sum += parseInt(d.value);
      return d.value;
    })).enter().append("svg:g").attr("class", "arc").attr("transform", "translate(" + (r + 120) + "," + (r + 140) + ")");
    ...
    arcs.append("svg:text").attr(
        ...
        function(d, i) {
          ...
          return ((data[i].value * 360 / sum) < 10) ? "rotate (" + (c[0] - 90) + ")translate(" + (labelr) + ","
              + ((data[i].value * 360 / sum) * 2) + ")" : "translate(" + (x / h * labelr) + ',' + (y / h * labelr) + ")";
...
Reports.search = {
  searchProjects: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'searchProjectsByCreationDateandString', {
      'str': jQuery('#projectReportSearchInput').val(),
      'from': jQuery('#from').val(),
      'to': jQuery('#to').val(),
      'progress': jQuery('#projectProgress option:selected').val(),
      'url': ajaxurl
    }, {
      "doOnSuccess": function(json) {
  ...
  searchProjectRunLane: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'searchProjectsByRunCompletionDateandString', {
      'str': jQuery('#projectRunLaneReportSearchInput').val(),
      'from': jQuery('#projectRunLanefrom').val(),
      'to': jQuery('#projectRunLaneto').val(),
      'url': ajaxurl
    }, {
      "doOnSuccess": function(json) {
  ...
  searchSamples: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'searchSamplesByCreationDateandString', {
      'str': jQuery('#sampleReportSearchInput').val(),
      'from': jQuery('#samplefrom').val(),
      'to': jQuery('#sampleto').val(),
  ...
  searchLibraries: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'searchLibrariesByCreationDateandString', {
      'str': jQuery('#libraryReportSearchInput').val(),
      'from': jQuery('#libraryfrom').val(),
      'to': jQuery('#libraryto').val(),
  ...
  searchRuns: function() {
    ...
    Fluxion.doAjax('flexReportingControllerHelperService', 'searchRunsByCreationDateandString', {
      'str': jQuery('#runReportSearchInput').val(),
      'from': jQuery('#runfrom').val(),
      'to': jQuery('#runto').val(),
      'runStartedFrom': jQuery('#runStartedFrom').val(),
      'runStartedTo': jQuery('#runStartedTo').val(),
...
jQuery(function() {
  var dates = jQuery("#calendarfrom, #calendarto")
      .datepicker(
          {
            defaultDate: "+1w",
            changeMonth: true,
            ...
            onSelect: function(selectedDate) {
              var option = this.id == "calendarfrom" ? "minDate" : "maxDate", instance = jQuery(this).data("datepicker"), date = jQuery.datepicker
                  .parseDate(instance.settings.dateFormat || jQuery.datepicker._defaults.dateFormat, selectedDate, instance.settings);
