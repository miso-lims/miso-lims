        ...
        try {
          ...
          if (user == null) {
            ...
            if (o instanceof UserDetails) {
              ...
              return JSONUtils
                  .SimpleJSONError("The UserDetailsService specified in the Spring config cannot support mapping of usernames to UserDetails objects");
            }
          } else {
    ...
    try {
      ...
      if (projects.size() > 0) {
        ...
        for (Project p : projects) {
          b.append("<a class=\"dashboardresult\" href=\"/miso/project/"
              + p.getProjectId()
  ...
  public JSONObject searchStudy(HttpSession session, JSONObject json) {
    ...
    try {
      ...
      if (studies.size() > 0) {
        ...
        for (Study s : studies) {
          b.append("<a class=\"dashboardresult\" href=\"/miso/study/"
              + s.getId()
              + "\"><div  onMouseOver=\"this.className=&#39dashboardhighlight&#39\" onMouseOut=\"this.className=&#39dashboard&#39\" class=\"dashboard\">");
    ...
    try {
      ...
      if (experiments.size() > 0) {
        ...
        for (Experiment e : experiments) {
          b.append("<a class=\"dashboardresult\" href=\"/miso/experiment/"
              + e.getId()
              + "\"><div  onMouseOver=\"this.className=&#39dashboardhighlight&#39\" onMouseOut=\"this.className=&#39dashboard&#39\" class=\"dashboard\">");
  ...
  public JSONObject searchRun(HttpSession session, JSONObject json) {
    ...
    try {
      ...
      if (runs.size() > 0) {
        ...
        for (Run r : runs) {
          b.append("<a class=\"dashboardresult\" href=\"/miso/run/"
              + r.getId()
              + "\"><div  onMouseOver=\"this.className=&#39dashboardhighlight&#39\" onMouseOut=\"this.className=&#39dashboard&#39\" class=\"dashboard\">");
        ...
        for (LibraryDilution ld : libraryDilutions) {
          if (ld != null) {
            if (ld.getLibrary() != null) {
              b.append("<a class=\"dashboardresult\" href=\"/miso/library/"
                  + ld.getLibrary().getId()
                  + "\"><div  onMouseOver=\"this.className=&#39dashboardhighlight&#39\" onMouseOut=\"this.className=&#39dashboard&#39\" class=\"dashboard\">");
    ...
    try {
      ...
      if (samples.size() > 0) {
        ...
        for (Sample s : samples) {
          b.append("<a class=\"dashboardresult\" href=\"/miso/sample/"
              + s.getId()
              + "\"><div  onMouseOver=\"this.className=&#39dashboardhighlight&#39\" onMouseOut=\"this.className=&#39dashboard&#39\" class=\"dashboard\">");
          b.append("Name: <b>" + s.getName() + "</b><br/>");
          b.append("Alias: <b>" + s.getAlias() + "</b><br/>");
