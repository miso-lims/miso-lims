                ...
                if (part.getPool() != null) {
                  ...
                  if (partitionInvolved) {
                    ...
                    sb.append("<li><input type='checkbox' id='" + r.getId() + "_" + partitionContainer.getId() + "_"
                        + part.getPartitionNumber() + "' name='partition' " + "itemLabel='" + part.getPartitionNumber()
                        + "' itemValue='PAR" + part.getId() + "' value='PAR" + part.getId()
                        + "' onclick='Submission.ui.togglePartitionContents(this)'");
                    ...
                    if (fpg == null) {
                      log.warn("No file path generator found for '" + r.getPlatformType().getKey()
