...
public class Dtos {
  ...
  private static SampleDto copySampleFields(@Nonnull Sample from, @Nonnull SampleDto dto, boolean includeBoxPositions,
    ...
    dto.setProjectAlias(from.getProject().getTitle());
    dto.setProjectShortName(from.getProject().getCode());
  ...
  public static LibraryDto asDto(@Nonnull Library from, boolean includeBoxPositions) {
    ...
    setString(dto::setProjectShortName, from.getSample().getProject().getCode());
    ...
    if (library != null) {
      ...
      if (sample != null) {
        ...
        if (sample.getProject() != null) {
          ...
          setString(dto::setProjectShortName, project.getCode());
        }
      }
    }
